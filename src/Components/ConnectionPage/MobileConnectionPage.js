            ...
            <Grid item container direction="row" className={classes.gridList} spacing={1}>
                {invites && invites.length !== 0 ? invites.map((invite) => (
                    <Grid item key={invite.uid}>
                        <Card variant="outlined" className={invite.card} onClick={() => { history.push("/connections/" + invite.uid); }}>
                            <Grid container direction="column" alignItems="center">
                                <Grid item>
                                    <Avatar
                                        src={invite.thumbnail_pic}
                                        alt="N"
                                        aria-label="Name"
                                        className={classes.avatar}
                                    />
